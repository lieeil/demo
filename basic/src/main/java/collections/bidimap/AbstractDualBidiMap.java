...
import collections.ResettableIterator;
import collections.collection.AbstractCollectionDecorator;
import collections.iterators.AbstractIteratorDecorator;
import collections.keyvalue.AbstractMapEntryDecorator;
...
public abstract class AbstractDualBidiMap implements BidiMap {
    ...
    protected static class EntrySetIterator extends AbstractIteratorDecorator {
        ...
        public Object next() {
            last = new MapEntry((Entry) super.next(), parent);
            canRemove = true;
            return last;
        }
