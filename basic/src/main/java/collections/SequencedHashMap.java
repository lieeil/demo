...
import collections.list.UnmodifiableList;
import collections.map.LinkedMap;
import collections.map.ListOrderedMap;
 ...
 * {@link List} because of incompatible interface definitions.
 * The remove methods in List and Map have different return values
 * (see: {@link List#remove(Object)} and {@link Map#remove(Object)}).
 * <p>
...
public class SequencedHashMap implements Map, Cloneable, Externalizable {
    ...
    /**
     * {@link Map.Entry} that doubles as a node in the linked list
