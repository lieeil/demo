...
import collections.IterableMap;
import collections.KeyValue;
import collections.MapIterator;
import collections.iterators.EmptyIterator;
import collections.iterators.EmptyMapIterator;
...
public class AbstractHashedMap extends AbstractMap implements IterableMap {
    ...
    protected void addMapping(int hashIndex, int hashCode, Object key, Object value) {
        ...
        size++;
//        System.out.println("checkCapacity in");
        checkCapacity();
//        System.out.println("checkCapacity out");
    }
...
//        System.out.println(Thread.currentThread().getName() + time + "ensureCapacity in");
        ...
        if (size == 0) {
            ...
            modCount++;
            printEntries(oldEntries, "########before########");
            ...
            printEntries(newEntries, "########after########");
            threshold = calculateThreshold(newCapacity, loadFactor);
            data = newEntries;
        }
//        System.out.println(Thread.currentThread().getName() + time + "ensureCapacity out");
    }

    private void printEntries(HashEntry[] entries, String type){
        System.out.println();
    ...
    private void print(HashEntry entry, String type){
